...
| Browser Web Adapter | **Diseño fijado** | Playwright en worker aislado; invocado por API/MCP, no desde el control plane. |

## Regla operativa

ECC, Superpowers, Graphify y UI/UX son capacidades globales. Las decisiones de producto, seguridad y entrega siguen viviendo en este repositorio. Codex/OpenCode consumen el contrato de `docs/AGENT_TOOL_CONTRACT.md`. La evidencia exacta del gate esta en `docs/SPRINT_0_EVIDENCE.md`.
